...
{
    class CListViewTabPage : Panel, ITabPage
    {
        #region  ITABPAGE
        ...
        public CExListView ListView
        {
            ...
            set { m_listView = value; initUI(); }
        }
        #endregion PROPERTY

        //数据实体
        #region DATAMEMBER
        private CExListView m_listView; //数据主体
        ...
        private void initUI()
        {
            ...
            m_listView.Margin = new System.Windows.Forms.Padding(0, 0, 3, 0);
            m_listView.Dock = DockStyle.Fill;
            m_listView.AutoSize = true;
            //m_dataGridView.ReadOnly = true; //只读

            m_panelBottom = new Panel();
            m_panelBottom.BackColor = Color.Gray;
            ...
            // 加入到布局控件中
            m_tableLayoutPanel.Controls.Add(m_listView, 0, 0);
            ...
            //绑定消息
            m_listView.ItemAdded += new EventHandler<CEventSingleArgs<int>>(this.EHItemAddedChanged);
            m_listView.CurrentPageChanged += new EventHandler<CEventSingleArgs<int>>(this.EHPageNumberChanged);
